...
async function createHandler(request: AgentRequest): Promise<SlashCommandHandlerResult> {
  if (['word', 'excel', 'powerpoint'].some(substring => request.userPrompt.toLowerCase().includes(substring.toLowerCase()))) {
    ...
    const objectJson = `
    {
      ...
      "Word.CommentCollection":"Contains a collection of Comment objects.",
      "Word.CommentContentRange":"Specifies the comment\'s content range.",
      "Word.CommentReply":"Represents a comment reply in the document.",
      "Word.CommentReplyCollection":"Contains a collection of CommentReply objects. Represents all comment replies in one comment thread.",
      ...
      "Word.ContentControlCollection":"Contains a collection of ContentControl objects.",
      "Word.CustomProperty":"Represents a custom property.",
      "Word.CustomPropertyCollection":"Contains the collection of CustomProperty objects.",
      "Word.CustomXmlPart":"Represents a custom XML part.",
      "Word.CustomXmlPartCollection":"Contains the collection of CustomXmlPart objects.",
      ...
      "Word.FieldCollection":"Contains a collection of Field objects.",
      "Word.Font":"Represents a font.","InlinePicture":"Represents an inline picture.",
      "Word.InlinePictureCollection":"Contains a collection of InlinePicture objects.",
      "Word.NoteItem":"Represents a footnote or endnote.",
      "Word.NoteItemCollection":"Contains a collection of NoteItem objects.",
      "Word.Paragraph":"Represents a single paragraph in a selection, range, content control, or document body.",
      "Word.ParagraphCollection":"Contains a collection of Paragraph objects.",
      "Word.ParagraphFormat":"Represents a style of paragraph in a document.",
      "Word.Range":"Represents a contiguous area in a document.",
      "Word.RangeCollection":"Contains a collection of Range objects.",
      ...
      "Word.SectionCollection":"Contains the collection of the document\'s Section objects.",
      "Word.Shading":"Represents the shading object.",
      "Word.Style":"Represents a style in a Word document.",
      "Word.StyleCollection":"Contains a collection of Style objects.",
      ...
      "Excel.Workbook":"Workbook is the top level object which contains related workbook objects such as worksheets, tables, and ranges.",
      "Excel.Worksheet":"An Excel worksheet is a grid of cells. It can contain data, tables, charts, etc. To learn more about the worksheet object model",
      "Excel.Range":"Range represents a set of one or more contiguous cells such as a cell, a row, a column, or a block of cells.",
      "Excel.Chart":"Represents a chart object in a workbook.",
      "Excel.ChartCollection":"A collection of all the chart objects on a worksheet.",
      "Excel.ChartType":"Specifies the type of a chart."
    }
    `;
    ...
    return { chatAgentResult: { metadata: { slashCommand: "create" } }, followUp: [NextStepFix, NextStepGenerate] };
  }
...
var apiWithDescriptionJson = [
  ...
  {
    "object": "Word.CommentContentRange",
  ...
  {
    "object": "Word.CommentReplyCollection",
  ...
  {
    "object": "Word.ContentControlCollection",
  ...
  {
    "object": "Word.ContentControlOptions",
  ...
  {
    "object": "Word.ParagraphCollection",
